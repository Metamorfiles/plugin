...
6. `render_preview` every format, fix every check error, compare each with the source, and fix until they read as one family. Then get an independent review with `metamorfiles-review`.
